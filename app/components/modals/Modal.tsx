...
interface ModalProps {
    ...
    disabled?:boolean
    sencondaryAction?:()=>void
    sencondaryActionLabel?:string
}
...
export const Modal: React.FC<ModalProps>= ({
    ...
    const handleSecondaryAction= useCallback(()=>{
        if (disabled|| !sencondaryAction){
            return
        }
        sencondaryAction()
    },[disabled, sencondaryAction])
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                            {sencondaryAction && sencondaryActionLabel && (
                                <Button
                                    outline
                                    disabled={disabled}
                                    label={sencondaryActionLabel}
